...
function Summary_Table2({ tableDataLeft, leftValues }, ref) {
  ...
  const [columns, setColumns] = useState([
    ...
    { title: "starting_point_first", field: "starting_point_first", width: 110 },
    { title: "starting_point_second", field: "starting_point_second", width: 80 },
    { title: "actual_value", field: "actual_value", width: 100 },
    { title: "pv0", field: "pv0", width: 100 },
    { title: "pv1", field: "pv1", width: 100 },
    { title: "pv2", field: "pv2", width: 100 },
    { title: "Left_pv", field: "Left_pv", width: 100 },
    { title: "Right_pv", field: "Right_pv", width: 100 },
    { title: "maxv", field: "maxv", width: 100 },
    ...
    { title: "MaxDeviation", field: "MaxDeviation", width: 80 },
    { title: "MinDeviation", field: "MinDeviation", width: 80 },
    { title: "MaxPL", field: "MaxPL", width: 80 },
    { title: "MinPL", field: "MinPL", width: 80 },
  ...
  return (
    <div style={{ height: 600, width: "100%" }}>
      ...
      <DataGrid
        hideFooter={true}
        rows={leftValues?.summary_data2?.map((item, i) => {
          item.id = i
          return (item)
        })}
        columns={columns}
...
export default forwardRef(Summary_Table2);
