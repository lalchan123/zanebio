...
function PointValue_Table({ tableDataLeft, leftValues }, ref) {
  ...
  const [columns, setColumns] = useState([
    ...
    { title: "points", field: "points", width: 80 },
    { title: "values_max", field: "values_max", width: 110 },
    { title: "values_min", field: "values_min", width: 110 }
  ]);
  // const [columns, setColumns] = useState([
  ...
  return (
    <div style={{ height: 600, width: "100%" }}>
      ...
      <DataGrid
        hideFooter={true}
        rows={leftValues?.point_value?.map((item, i) => {
          item.id = i
          return (item)
        })}
        columns={columns}
...
export default forwardRef(PointValue_Table);
