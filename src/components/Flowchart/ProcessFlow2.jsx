...
import CustomNodeFilter2 from "./CustomNode/CustomNodeFilter2.jsx";
...
import CustomSourceNode2 from "./CustomNode/CustomSourceNode2.jsx";
import CustomFormulaNode2 from "./CustomNode/CustomFormulaNode2.jsx";
...
import useMutationDeletedRel2 from "../../GraphQLApiCall/useMutationDeletedRel2.js";
import useMutationRel2 from "../../GraphQLApiCall/useMutationRel2.js";
import useMutationUpdateRel from "../../GraphQLApiCall/useMutationUpdateRel.js";
import CustomNodeJoin2 from "./CustomNode/CustomNodeJoin2.jsx";
import GetAllTableData from "../../GraphQLApiCall/GetAllTableData.js";
import GetQueryRel2 from "../../UseContext/GetQueryRel2.js";
...
function ProcessFlow2() {
  ...
  const process_flow = GetQueryRel2(544, 1, "", userId);
  const data_flow = GetQueryRel2(471, 0, "", userId);
  ...
  data_flow?.getTableDataRelIdInfo2?.map((item, i) => {
  ...
  useEffect(() => {
    process_flow?.getTableDataRelIdInfo2?.map((item1, i) => {
  ...
  const onMutationLogicSave = () => {
    let check = false;
    process_flow?.getTableDataRelIdInfo2?.map((item, i) => {
