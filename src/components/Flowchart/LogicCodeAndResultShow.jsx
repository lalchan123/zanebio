...
function LogicCodeAndResultShow() {
  const { setLogicEditor, logicCode, setLogicCode } = useContext(AppContext);
...
export default memo(LogicCodeAndResultShow);
