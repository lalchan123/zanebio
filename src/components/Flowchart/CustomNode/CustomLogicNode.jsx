      ...
      >
        ...
        <Tooltip title="Save" placement="top">
          <IconButton
            ...
            aria-label="delete"
            size="small"
            onClick={saveCodeNodeData}
            onChange={saveCodeNodeData}
            value={"demo"}
            nodeId={id}
          >
            <Box
...
export default memo(CustomLogicNode);
