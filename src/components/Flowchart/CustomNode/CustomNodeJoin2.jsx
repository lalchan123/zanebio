...
function CustomNodeJoin2({
 ...
 const [csvFile, setCsvFile] = useState(null);
  ...
  console.log("fileNameJoin", fileNameJoin);
  console.log("sourceDataKeyName", sourceDataKeyName);
  console.log("selectKey", selectKey);
  console.log("nodes", Node);

  console.log("joinNameDic", joinNameDic)


  const saveJoinNodeData = (evt) => {
    const { nodes } = store.getState();
    console.log("joinNameDic", joinNameDic)
    setNodes(
      nodes.map((node) => {
      ...
      >
        ...
        <Tooltip title="Save" placement="top">
          <IconButton
            ...
            aria-label="delete"
            size="small"
            onClick={saveJoinNodeData}
            onChange={saveJoinNodeData}
            value={"demo"}
            nodeId={id}
          >
            <Box
...
export default memo(CustomNodeJoin2);
