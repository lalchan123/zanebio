...
import TestDataShowTable from "../TestDataShowTable/TestDataShowTable.jsx";
...
import GETDynamicTableFieldOnlyColumn1 from "../../../GraphQLApiCall/GETDynamicTableFieldOnlyColumn1.js";
...
function CustomSourceNode({
  ...
  const allTableNameList = eval(all_table_col?.getAllTableColumn?.jsonData);
  ...
  const [jsonTableId, setJsonTableId] = useState("");
  const [fileName, setFileName] = useState([]);
  const [jsonTableName, setJsonTableName] = useState("");
  // const [jsonTableColData, setJsonTableColData] = useState([]);
  ...
  console.log("363 jsonTableColData", jsonTableColData)
  // const onJsonTableColNameSet = () => {
  //   const json_data = GetJsonTableColData(db, userId, jsonTableName)
  //   console.log("364 json_data", json_data)
  //   setJsonTableColData(eval(json_data?.json_table_col_data?.getJsonTableColData?.jsonData))
  // };
  ...
  // const getTableData = GETDynamicTableFieldOnlyColumn1(tableId);
  // const allTableDataJson = eval(
  //     getTableData?.all_table_data?.getDynamicTableFieldOnlyColumn1?.jsonData
  // );
...
export default memo(CustomSourceNode);
