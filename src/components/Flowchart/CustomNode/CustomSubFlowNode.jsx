      ...
      >
        ...
        <Tooltip title="Save" placement="top">
          <IconButton
            ...
            aria-label="delete"
            size="small"
            onClick={saveSubflowNodeData}
            onChange={saveSubflowNodeData}
            value={"demo"}
            nodeId={id}
          >
            <Box
        ...
        <Box sx={{ display: "inline" }}>
          ...
          <Tooltip title="subflow" placement="top">
            <IconButton
              aria-label="delete"
              size="small"
              onClick={() => {
...
export default memo(CustomSubFlowNode);
